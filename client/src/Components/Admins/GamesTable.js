...
class GamesTable extends Component {
  ...
  componentDidMount() {
    axios.get("http://localhost:5000/api/admin/getgamesrecords").then((res) => {
            ...
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">
                  Update Record for {this.state.name}
                </h4>
              </div>
  ...
  updateRecord = () => {
    ...
    return axios
      .patch("http://localhost:5000/api/admin/updategamesrecords", data)
      .then(
        this.setState({
          updated: true,
        })
  ...
  render() {
    ...
    if (this.state.updated == true) {
      axios
        .get("http://localhost:5000/api/admin/getgamesrecords")
        .then((res) => {
